...
void loop()
{
  ...
  if ( now - t_dirchange > 5000 )
  {
    ...
    //switch between pos 200 and 0 depending on direction
  }
  ...
  if( now - t_echo > 100 )
  {
    ...
    Serial.println(motor.readRegister(TMC5160_Reg::GLOBAL_SCALER));
    Serial.print("IHOLD_IRUN: ");
    Serial.println(motor.readRegister(TMC5160_Reg::IHOLD_IRUN), HEX);
    Serial.print("GCONF: ");
    Serial.println(motor.readRegister(TMC5160_Reg::GCONF), HEX);
  }
}